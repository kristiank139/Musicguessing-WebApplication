"""
Django settings for musicguessingapp project.
...
SECRET_KEY = 'django-insecure-@_9k@19uogffw8f!n(fk=d6t3i8t11y+lpui8xn6ab(2ayc4rh'
...
INSTALLED_APPS = [
    ...
    'rest_framework' # Framework, mis serveerib andmeid frontend'i
]
...
ROOT_URLCONF = 'musicguessingapp.urls'
...
WSGI_APPLICATION = 'musicguessingapp.wsgi.application'
